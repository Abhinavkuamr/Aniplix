...
export default function Popular() {
    ...
    const URL_movie = "https://web-production-a8e9.up.railway.app/anime-movies"
    const [movie, setPopular] = useState([])
    ...
    const fetchData = async () => {
        ...
        try{
            ...
            const response = await axios.get(URL_movie + `?page=${currentPage}&aph=0`)
